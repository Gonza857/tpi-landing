import { Building2, Target, Lightbulb, Coins, BarChart3, Trophy } from "lucide-react"
    ...
    const features = [
        {
            ...
            description:
                "Panel principal con mapa donde se construyen edificios que afectan energía, contaminación y felicidad.",
        },
        {
            icon: Target,
            title: "Misiones y retos diarios",
            description: "Objetivos que enseñan decisiones sustentables y recompensan el progreso.",
        },
        {
            icon: Lightbulb,
            title: "Consejos y concientización",
            description:
                "El usuario obtendrá consejos tanto dentro del juego como tips para la concientización del medio ambiente.",
        },
        {
            icon: Coins,
        ...
        },
        {
            ...
            description: "HUD visible con datos claves para el jugador entienda el impacto de sus decisiones.",
        },
        {
            icon: Trophy,
            title: "Ranking",
            description: "Competencia global y semanal basada en desempeño ambiental y social.",
        },
    ]
            ...
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
                        Descubre todas las características que hacen de NeoCivita una experiencia única de aprendizaje y diversión
                    </p>
                </div>
